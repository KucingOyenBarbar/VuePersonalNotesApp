  ...
  <div class="card nl_card_item">
    <div class="card-body">
      <div class="d-flex justify-content-end g-2">
        <span v-if="!item.archived" class="badge rounded-pill text-bg-success"
          >Aktif</span
        >
        <span v-if="item.archived" class="badge rounded-pill text-bg-warning"
          >Diarsipkan</span
        >
      </div>
      ...
      <div className="px-0 mx-0 position-absolute nl_card_item_button  px-3">
